...
router.post('/itemproduct', authentication, adminRole, upload.array("imageProduct", 3), itemController.addItem)
router.put('/item/:itemId', authentication, adminRole, upload.array("imageProduct", 3), itemController.updateItem)
